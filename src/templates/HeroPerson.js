...
function HeroPerson({ h1_title, imageBackground, imagePoster, birthday, vote_average, known_for_department, biography, place_of_birth, also_known_as }) {
    return (
        <>
            <header
            ...
            >
                ...
                >
                    ...
                    <div className="flex flex-col justify-start items-start w-full">
                        <h2 className="text-3xl text-white font-extrabold w-full text-left pb-2 mt-6">Biography</h2>
                        <p
