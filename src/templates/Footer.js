...
function Footer() {
    return ( 
        <footer className="absolute z-40 p-4 w-full bg-white dark:bg-gray-800
            sm:p-1">
            <div className="mx-auto max-w-screen-xl">
                <div className="flex  justify-between
                    ...
                    <div className="mb-6 md:mb-0">
                        <Logo 
                            icon={<RiMovie2Line className="w-full h-full" />}
                            brand={'MovieApp'}
                        />
                    </div>
                ...
                <div className="flex items-center justify-between
                    ...
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="#" className="hover:underline">MovieApp</a>. All Rights Reserved.
                    </span>
