        ...
        <>
            <header className="relative z-20 pt-16 smMin:px-10 w-full !h-full flex justify-between items-center
                ...
                <div className="h-full py-5 w-full flex flex-col justify-start items-center ml-10
                    ...
                    {tagline && <p className="italic text-left underline text-version3 w-full py-2 
                        lg:mb-2">"{tagline}"</p>}
                    ...
                    <div className="w-full flex justify-start items-center py-2
                        ...
                        <Link href={homepage}>
                            <span className="flex text-gray-400 font-medium mr-4
                                md:w-full">
                    ...
                    <p className="w-full text-left py-2 text-gray-400">
                            Genres included: {`${genres.map(genre => ' ' + genre.name)}`}
                    </p>
                    ...
                    <div className="flex flex-col justify-start items-start w-full">
                        ...
                        <div className="text-gray-100 font-medium flex bg-gray-100/10 rounded-lg p-1 gap-2 mb-10 
                            sm:w-[320px] sm:overflow-scroll">
                            {production_companies.map(company => (
                                <div key={company.name+company.id} className="w-36 h-36 flex flex-col justify-center items-center
