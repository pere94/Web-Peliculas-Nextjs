...
// import { TvContent } from '/src/components/TvContent';
            ...
            <div className="relative z-[90]">
                <div className="w-full ">
                    <button
                        ...
                        className={`primaryButton px-2 py-2 rounded-l-none 
                        fixed !z-100 top-20 ${showModal ? 'left-64' : 'left-0'} duration-300 m-0`}
                        type="button"
                    >
                        {' '}
                ...
                >
                    ...
                    <div className="mb-6">
                        <Tab setTabNameActive={setTabNameActive} tabNameActive={tabNameActive} tabsNames={['Movies', 'Tv Shows', 'Actors']} />
                    </div>

                    {tabNameActive == 'Movies' && <TabMovieContent handleClickShowModal={handleClickShowModal} />}

                    {
                        tabNameActive == 'Tv Shows' && <p>Tv Shows</p>
                        // <TvContent handleClickShowModal={handleClickShowModal}/>
                    }

                    {tabNameActive == 'Actors' && <p>Actors</p>}
                </div>
            </div>
        </>
    );
