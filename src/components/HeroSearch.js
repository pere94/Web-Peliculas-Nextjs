    ...
    return (
        <div className="">
            <div className="flex justify-center items-center h-10 mt-10 w-full relative">
                ...
                <svg id="svg_search" xmlns="http://www.w3.org/2000/svg" className="z-[60] h-[68px] min-h[68px] w-[68px] min-w-[68px]
            ...
            {showModalResult && 
                <div className="flex flex-col p-1 relative top-1 -left-4 z-50 bg-white dark:bg-gray-800 dark:border-gray-700 gap-2
